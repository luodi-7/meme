...
output_dir = "/mnt/afs/xueyingyi/image_vague/quickmeme_ocr_replace"
jsonl_file = "/mnt/afs/xueyingyi/image_vague/loc_dection/dections_quickmeme.jsonl"  # JSONL 文件路径
error_log_file = "/mnt/afs/xueyingyi/image_vague/error_log_2.txt"  # 错误日志文件路径
