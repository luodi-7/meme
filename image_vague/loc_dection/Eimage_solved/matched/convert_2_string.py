...
input_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/matched/eval_data.jsonl'  
output_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/matched/eval_data_processed.jsonl'  
...
def process_line(line):  
    ...
    gpt_string = '\n'.join([f"{item['bbox']}: {item['text']}" 
                            ...
                            if not any(substring in item['text'] for substring in [".net"])])  
