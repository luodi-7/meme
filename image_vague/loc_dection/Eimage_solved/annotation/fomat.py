...
input_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotation/eval_data_replaced.jsonl'  # Update this with your input file path  
output_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotation/eval_data_format.jsonl'  # Update this with your desired output file path  
