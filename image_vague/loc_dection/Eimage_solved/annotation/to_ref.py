...
# 读取原始的JSONL文件
input_file = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotation/train_data_format.jsonl'
output_file = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotation/train_data_ref.jsonl'
