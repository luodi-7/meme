...
path = '/mnt/afs/xueyingyi/model/loc_stage_1/'
...
pixel_values1 = load_image('/mnt/afs/xueyingyi/image_vague/inpainting_demo/image_ (0).jpg', max_num=12).to(torch.bfloat16).cuda()
pixel_values2 = load_image("/mnt/afs/xueyingyi/image_vague/inpainting_demo/image_ (896).jpg", max_num=12).to(torch.bfloat16).cuda()
...
question = 'I\'m going to give you a sentence and a picture. Please divide the whole sentence sensibly and place each in the right place in the picture to convey the meaning of the whole picture humor. Finally, please give me the text box coordinates location and the corresponding text.\nFor example, this picture:\n<image>\nthis sentence:That moment after you throw up and your friend asks you \"YOU GOOD BRO?\" I\'M FUCKIN LIT\nthe answer should be:<ref>Writable text area</ref><box>[[0000, 0001, 0992, 0290]]</box>:that moment after you throw up and your friend asks you \"you good bro?\",\n<ref>Writable text area</ref><box>[[0276, 0801, 0746, 0903]]</box>:i\'m fuckin lit\nNow look at this picture:\n<image>\n Now, please deal with this sentence: -EXPECT LEAST FROM OTHERS\n-ENJOY YOUR OWN COMPANY\nTHANKS ALOT MR. BEAN!!!\nFOR TEACHING US THESE IMPORTANT LIFE LESSONS...\nThank You Mr. Bean..:)'
