...
from internvl.train.constants import (BOX_END_TOKEN, BOX_START_TOKEN,
                                      ...
                                      REF_START_TOKEN)
from internvl.train.dataset_classification import (ConcatDataset, TCSLoader,
        ...
        if self.group_by_length:
            ...
            for data_item in self.raw_data:
                ...
                if 'length' in data_item:
                    ...
                    conversations = '\n'.join([temp['value'] if temp['from'] != 'gpt' else '' for temp in data_item['conversations']])
