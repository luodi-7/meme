...
path = '/mnt/afs/share/InternVL25-4B/'
...
pixel_values = load_image('/mnt/afs/xueyingyi/image_vague/image/image_ (0).jpg', max_num=12).to(torch.bfloat16).cuda()
...
question = 'reading text in the graph'
