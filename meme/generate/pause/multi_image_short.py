...
output_json_file = '/mnt/afs/xueyingyi/meme/generate/pause/inference/all_item/short_config/max_64.jsonl'
...
with open(output_json_file, 'w') as output_file:
    ...
    with open(jsonl_path, 'r') as file:
        for line in file:
            ...
            # 设置生成配置
            generation_config = dict(max_new_tokens=64, do_sample=False, num_beams=1)
            # 加载示例图像和用户推理图像
