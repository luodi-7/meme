...
user_input_jsonl_path = '/mnt/afs/xueyingyi/meme/generate/omit/C_generate_multi_omit.jsonl'  # user_input.jsonl文件路径
output_jsonl_path = '/mnt/afs/xueyingyi/meme/generate/omit/Cjson/C_generate_multi_all_item.jsonl'  # 输出JSONL文件路径
train_jsonl_path = '/mnt/afs/xueyingyi/meme/generate/omit/Cjson/C_generate_train_multi_all_item.jsonl'  # 训练集路径
eval_jsonl_path = '/mnt/afs/xueyingyi/meme/generate/omit/Cjson/C_generate_eval_multi_all_item.jsonl'  # 测试集路径
train_config_path = '/mnt/afs/xueyingyi/meme/generate/omit/C_generate_train_multi_all_item.jsonl'  # 训练集配置文件路径
eval_config_path = '/mnt/afs/xueyingyi/meme/generate/omit/C_generate_eval_multi_all_item.jsonl'  # 测试集配置文件路径
