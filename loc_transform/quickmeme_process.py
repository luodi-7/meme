...
# 输入文件和输出文件路径
input_jsonl_path = "/mnt/afs/xueyingyi/image_vague/loc_dection/dections_quickmeme.jsonl"
output_jsonl_path = "/mnt/afs/xueyingyi/loc_transform/quickmeme_processed/transformed_data.jsonl"
empty_detections_jsonl_path = "/mnt/afs/xueyingyi/loc_transform/quickmeme_processed/empty_detections.jsonl"
